...
public class BleDefinedUUIDs {
	...
	public static class Service {
		...
		final static public UUID UNKNOWN_SERVICE          = UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb");
	};
	
	public static class Characteristic {
		final static public UUID UNKNOWN_CHARACTERISTIC   = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");
